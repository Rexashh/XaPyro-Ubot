...
async def main():
    ...
    for bot in bots:
        try:
            ...
            await bot.join_chat("Xa_cmd")
            await bot.join_chat("rexaprivateroom")
            try:
    ...
    LOGGER("ProjectMan").info(f"XaPyro-UserBot v{BOT_VER} [🔥 BERHASIL DIAKTIFKAN! 🔥]")
...
if __name__ == "__main__":
    LOGGER("ProjectMan").info("Starting XaPyro-UserBot")
    install()
    heroku()
